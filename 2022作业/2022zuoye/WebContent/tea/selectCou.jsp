	...
	<div class="main_left">
		...
		<input class="reset" type="button" value="注销" onClick="window.location.href=('/2021zuoye/index.jsp')">
	  	...
	  	if(session.getAttribute("teacher")==null){
	  		response.sendRedirect("/2021zuoye/index.jsp");
	  	}else{
			...
			<div class="form">
				<table>
  					...
  					<tr>
  						...
  						<td><input class="btn" type="button" value="添加课程" onclick="window.location.href=('/2021zuoye/tea/InsertCou.jsp')"/></td>
  					...
  					<td><input  class="btn" type="button" value="修改课程" onClick="window.location.href=('/2021zuoye/tea/updateCou.jsp?id=<%= cou.getCNo() %>')"></td>
  					<td><input  class="btn" type="button" value="删除课程" onClick="window.location.href=('/2021zuoye/servlet/serDeleteCou?id=<%= cou.getCNo() %>')"></td>
  					</tr>
		  				<%
		   			}
		   		}
