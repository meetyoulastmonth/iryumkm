			...
			<div class="form">
				<table>
  					...
  					<tr>
  						...
  						<td><input class="btn" type="button" value="添加学生" onclick="window.location.href=('/2021zuoye/tea/InsertStu.jsp')"/></td>
  					...
  					<td><input class="btn" type="button" value="修改信息" onClick="window.location.href=('/2021zuoye/tea/updateStu.jsp?id=<%= stu.getSNo() %>')"></td>
  					<td><input class="btn" type="button" value="删除信息" onClick="window.location.href=('/2021zuoye/servlet/serDeleteStu?id=<%= stu.getSNo() %>')"></td>
  					</tr>
  					<%} %>
  				</table>
  			<div class="form_1">
