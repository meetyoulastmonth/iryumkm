  ...
  <%
  		...
  		<%
				...
				%> 
						...
						<td><input class="btn" type="button" value="修改教室" onclick="window.location.href=('/2021zuoye/servlet/serUpdateClass?sno=<%=tem.getSNo() %>&cno=<%=tem.getCNo() %>&type=<%= type %>&key=<%=queryKey%> ')"/></td></tr>
